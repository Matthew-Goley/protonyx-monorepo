...
│   │   ├── hooks/                # useLensAnalysis.ts (react-query POST /analyze from positions+risk cookies, shared cache), usePortfolioHistory.ts (real equity curve from batched /tickers/history)
│   │   ├── components/
