...
│   │   │   ├── widgets/          # DashboardWidgets.tsx (Positions, Total Equity, Sharpe, Composition, Beta, Dividend Calendar) + PortfolioVector.tsx (Portfolio Momentum status-ladder widget) + CautionScoreWidget.tsx (flagship Caution Score tile) + GeneratingBrief.tsx (auto-fitting typewriter Lens Brief readout)
