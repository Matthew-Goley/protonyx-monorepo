...
│   │       └── settings.ts        # PUT /settings/risk-tier - per-user risk profile in Postgres (users.risk_tier)
│   ├── package.json
│   ├── tsconfig.json
