...
│   │   │   ├── widgets/          # DashboardWidgets.tsx (Positions, Total Equity, Sharpe, Composition, Beta, Dividend Calendar) + PortfolioVector.tsx (Portfolio Momentum status-ladder widget) + CautionScoreWidget.tsx (flagship Caution Score tile, compact CautionGauge) - the latter two re-exported from DashboardWidgets
